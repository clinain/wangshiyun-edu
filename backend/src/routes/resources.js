...
// 需要认证的路由
router.post('/upload', auth, uploadResource, resourceController.uploadResource);
...
router.get('/:id/preview', optionalAuth, resourceController.previewResource);
router.get('/:id/preview-text', optionalAuth, resourceController.previewTextResource);
